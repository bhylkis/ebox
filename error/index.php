    ...
    <div class="c-err">
        ...
        <div class="row ">
            ...
            <h3>Halaman Tidak Ditemukan</h3>
                        <p style="font-family:Poppins"><i class="fa fa-heart fa-spin"></i>  Silahkan kembali ke halaman utama <i class="fa fa-heart fa-spin"></i></p>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12">
                ...
                All Rights Reserved | &copy 2021 by Kelompok 5
            </div>
