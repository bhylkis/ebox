...
if (@$_SESSION["user"]) {
?>
<title><?php echo $data2["nama_user"];?> | Galeri Anda</title>
<?php
}
else{
?>
...
$by = @$_GET["by"];
$databy = mysqli_fetch_array(mysqli_query($db, "SELECT*FROM user WHERE user_user='$by'"));
if ($databy) {
?>
<style>
	.teguh{
...
<div id="page-inner">
 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Galeri <a href="./?p=user&user=<?php echo $databy["user_user"];?>"><?php echo $databy["nama_user"];?></a></h1>
                        <h1 class="page-subhead-line"><li class="fa fa-photo"></li> Semua Photo Dari Postingan <b><?php echo $databy["nama_user"];?></b></h1>                  
            </div>
            </div>
<?php
$batas = 8;
