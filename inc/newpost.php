...
?>
<title><?php echo $datauseruser["nama_user"]; ?> | Tambah Postingan</title>
<?php
...
?>
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Post Saran dan Kritik Anda</h1>
                <h1 class="page-subhead-line">
                    <li class="fa fa-pencil fa-spin"></li> Masukan saran dan kritik Anda disini
                </h1>
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div style="margin-top:20px;">
                <input title="Masukan Judul Postingan" required type="text" name="judul" placeholder="Kategori Saranmu adalah.." style="border:none;height:100px;width:100%;font-size:40px;">
                <hr>
                <div style="margin-top:20px;">
                    <textarea title="Masukan Isi Postingan" name="isi" rows="20" style="border:none;font-size:17px;width:100%;" placeholder="Berikan saran dan kritik Anda..."></textarea>
                </div><br>
...
?>
    <script>
        window.location = '.?p=posting&profil=<?php echo $data2["user_user"]; ?>';
    </script>
<?php
}
?>