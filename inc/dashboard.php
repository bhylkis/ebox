...
?>
    <title><?php echo $data2["nama_user"]; ?> | Beranda</title>
<?php
} else {
?>
    <title>Beranda</title>
...
<div id="page-inner">
    <div class="row">
        <div class="col-md-12">
            ...
            <h1 class="page-subhead-line">
                ...
                if (@$_SESSION["user"]) {
                ?>
                    <b><?php echo $data2["nama_user"]; ?> (<?php echo $data2["user_user"]; ?>)</b>! <a href="./?p=posting&profil=<?php echo $data2["user_user"]; ?>">
                        <li class="fa fa-pencil"></li> Berikan Saranmu
                    </a> Di Ebox 26
                <?php
                } else {
                ?>
    ...
    ?>
        <div class="alert alert-info" id="post<?php echo $datasqlpost["id_post"]; ?>">
            ...
            <a href="./?p=post&id=<?php echo $datasqlpost["id_post"]; ?>&post_by=<?php echo $datasqlpost["penulis_post"]; ?>">
                <h2><b><?php echo $datasqlpost["judul_post"]; ?></b></h2>
            </a>
            <?php
            if ($datauserpost["pp_user"] == '') {
            ?>
                <a href="./?p=user&user=<?php echo $datasqlpost["penulis_post"]; ?>"><img src="./assets/img/user/user2.jpg" style="width:40px;height:40px;border-radius:100%;"> <b><?php echo $datauserpost["nama_user"]; ?></b></a>
            <?php
            } else {
            ?>
            ...
            ?>
            <span style="float:right"><i class="fa fa-comment"></i> : <?php $totalkomentarpost = mysqli_num_rows(mysqli_query($db, "SELECT*FROM komentar WHERE id_post='$datasqlpost[id_post]'"));
                                                                        echo $totalkomentarpost; ?></span>
            <hr>
            ...
            while ($datakomentarnya = mysqli_fetch_array($komentarnya)) {
                ...
                if ($ygomen["pp_user"] == '') {
            ?>
                    <img src="./assets/img/user/user2.jpg" style="width:20px;height:20px;border-radius:100%"><b><a href="./?p=user&user=<?php echo $datakomentarnya["penulis_komentar"]; ?>"><?php echo $ygomen["nama_user"]; ?></a></b> : <?php echo $datakomentarnya["isi_komentar"]; ?><font style="float:right;">
                        << /font><br>
                        <?php
                    } else {
                        ?>
                ...
                if (@$_SESSION["user"]) {
                        ...
                        <span>
                            ...
                            - <button class="btn btn-info btn<?php echo $datasqlpost["id_post"]; ?>"><i class="fa fa-comment-o"></i> Komentar</button>
                        </span><br><br>
                        ...
                        ?>
                            <a href="./login?post=<?php echo $url; ?>?p=post&id=<?php echo $datasqlpost["id_post"]; ?>&post_by=<?php echo $datasqlpost["penulis_post"]; ?>"><i class="fa fa-sign-in"></i> Masuk Untuk memberikan saran dan kritik Anda</a>
                        <?php
                    }
                        ?>
