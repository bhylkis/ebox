<?php
mysqli_query($db, "UPDATE lihat SET lihat='0' WHERE user_lihat='$_SESSION[user]' AND apa_lihat='like'");
...
?>
<title><?php echo $datauseruser["nama_user"]; ?> | Notifikasi </title>
<?php
...
?>
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h3 class="page-head-line">Notifikasi Postingan yang Anda sukai!</h3>
                <h3 class="page-subhead-line">Jika Pengguna Lain Menyukai postingan Anda <b><?php echo $data2["nama_user"]; ?></b>, Maka Akan Tampil Disini</h3>
                ...
                <div>
                    ...
                    if (empty($hitung)) {
                        echo "<div class='alert alert-warning'>Belum ada yang menyukai postingan Anda</div>";
                    } else {
                    ...
                    ?>
                                <div class='alert alert-warning'><small><?php echo $datakomennya["tanggal_suka"]; ?></small><br><i class='fa fa-thumbs-o-up'></i>
                                    ...
                                    ?><b><a href="./?p=user&user=<?php echo $datakomennya["user_suka"]; ?>">@<?php echo $datakomennya["user_suka"]; ?></a></b> Menyukai Postingan<b><a href="./?p=post&id=<?php echo $datapostnya["id_post"]; ?>&post_by=<?php echo $datapostnya["penulis_post"]; ?>"><?php echo $judulpostnya; ?></a></b> Anda
                                </div>
                            <?php
                                ...
                                <div class='alert alert-info'><small><?php echo $datakomennya["tanggal_suka"]; ?></small><br><i class='fa fa-thumbs-o-up'></i>
                                    <b><a href="./?p=user&user=<?php echo $datakomennya["user_suka"]; ?>"><?php if ($datakomentar["pp_user"] == '') {
                                            ...
                                            ?>
                                                ...
                                                ?>@<?php echo $datakomennya["user_suka"]; ?></a></b> Menyukai Postingan <b><a href="./?p=post&id=<?php echo $datapostnya["id_post"]; ?>&post_by=<?php echo $datapostnya["penulis_post"]; ?>"><?php echo $judulpostnya; ?></a></b> Anda
                                </div>
                    <?php
                            }
                        }
