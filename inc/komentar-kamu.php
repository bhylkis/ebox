...
?>
<title><?php echo $datauseruser["nama_user"]; ?> | Notifikasi Komentar</title>
<?php
    ...
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-subhead-line">Jika Pengguna Lain Berkomentar di Postingan <b><?php echo $data2["nama_user"]; ?></b>, Maka Akan Tampil Disini</h3>
                ...
                <div>
                    ...
                    ?>
                                <div class='alert alert-warning'><small><?php echo $datakomennya["tanggal_komentar"]; ?></small><br><i class='fa fa-comment-o'></i>
                                    ...
                                    ?><b><a href="./?p=user&user=<?php echo $datakomennya["penulis_komentar"]; ?>">@<?php echo $datakomennya["penulis_komentar"]; ?></a></b> Ngomenin Postingan <b><a href="./?p=post&id=<?php echo $datapostnya["id_post"]; ?>&post_by=<?php echo $datapostnya["penulis_post"]; ?>#komentar_<?php echo $datakomennya["id_komentar"]; ?>"><?php echo $judulpostnya; ?></a></b> Kamu
                                </div>
                            <?php
                                ...
                                <div class='alert alert-info'><small><?php echo $datakomennya["tanggal_komentar"]; ?></small><br><i class='fa fa-comment-o'></i>
                                    <b><a href="./?p=user&user=<?php echo $datakomennya["penulis_komentar"]; ?>"><?php if ($datakomentar["pp_user"] == '') {
                                            ...
                                            ?>
                                                ...
                                                ?>@<?php echo $datakomennya["penulis_komentar"]; ?></a></b> Mengomentari Postingan <b><a href="./?p=post&id=<?php echo $datapostnya["id_post"]; ?>&post_by=<?php echo $datapostnya["penulis_post"]; ?>#komentar_<?php echo $datakomennya["id_komentar"]; ?>"><?php echo $judulpostnya; ?></a></b>Anda
                                </div>
                    <?php
                            }
                        }
