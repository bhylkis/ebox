    ...
    <div id="page-inner">
        <div class="alert alert-info">
            ...
            Penulis : <a href="./?p=user&user=<?php echo $datapost["penulis_post"]; ?>">@<?php echo $datapost["penulis_post"]; ?></a> | Pada : <u><?php echo $datapost["tanggal_post"]; ?></u> <span style="float:right;"><i class="fa fa-thumbs-up"></i> : <?php echo $datapost["suka_post"]; ?>
                ...
                ?>
                    <a style="color:darkred;" href="#" onclick="window.location='./inc/unlike.php?id=<?php echo $idpost; ?>&u=<?php echo $datapost["penulis_post"]; ?>';">Dukung</a>

                <?php
                } else {
                ?>
                    <a href="#" onclick="window.location='./inc/like.php?id=<?php echo $idpost; ?>&u=<?php echo $datapost["penulis_post"]; ?>';">Komentar</a>
                <?php
                }
                ?>
            </span>
...
?>
    <form method="post" action="./inc/ngomen.php?p=<?php echo $datapost["id_post"]; ?>&a=<?php echo $datapost["penulis_post"]; ?>" id="komentar" style="margin-top:35px;">
        <input type="text" placeholder="Masukan Komentar Anda" name="komentari" style="height:34px;width:100%;">
    </form>
<?php
            } else {
?>
    <a href="./login?post=<?php echo $url; ?>?p=post&id=<?php echo $datapost["id_post"]; ?>&post_by=<?php echo $datapost["penulis_post"]; ?>"><i class="fa fa-sign-in"></i> Sign In untuk memberikan saran</a>
<?php
            }
?>
    ...
    ?>
            ...
            <b>
                <a href="./?p=user&user=<?php echo $datakomentar["penulis_komentar"]; ?>">
                    ...
                    ?>
                        <img src="./assets/img/user/user2.jpg" style="width:25px;height:25px;border-radius:100%;">
                    <?php
                    } else {
                    ?>
            ...
            ?><a href="./inc/hapus-komentar?id=<?php echo $datakomentar["id_komentar"]; ?>" style="float:right;" class="abc" title="Hapus Komentar" onclick="return confirm('Hapus komentar dari postingan ini?')">X</a><?php
                                                                                                                                                                                                                    } elseif (@$datakomentar["penulis_komentar"] == @$data2["user_user"]) {
                                                                                                                                                                                                                        ?><a href="./inc/hapus-komentar?id=<?php echo $datakomentar["id_komentar"]; ?>" style="float:right;" class="abc" title="Hapus Komentar" onclick="return confirm('Hapus Komentar Anda?')">X</a><?php
                                                                                                                                                                                                                    }
                                                                                                                                                                                                            ?>
